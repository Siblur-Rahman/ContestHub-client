      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md dark-border-gray-700 bg-slate-200 focus:dark-border-violet-400"
          />
          {errors.contestName && (
        ...
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md bg-slate-200 dark-border-gray-700 focus:dark-border-violet-400"
          />
          {errors.image && (
        ...
        <div className="space-y-1 text-sm">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-md dark-border-gray-700 bg-slate-200 dark-text-gray-100 focus:dark-border-violet-400"
          />
        ...
        <div className="space-y-1 text-sm">
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-md bg-slate-200 text-black"
          >
