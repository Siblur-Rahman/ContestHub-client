    ...
    <div className="">
      ...
      <div className="flex flex-col lg:flex-row w-full container mx-auto  gap-5 ">
        <div className="w-full lg:w-1/3  p-4  sticky top-10">
          <div className="justify-around p-4 text-center rounded-lg lg:-mt-32 border w-full mx-auto ">
            <img
              src={displayPhotoURL}
              alt={displayName}
          ...
          <div className="justify-around p-8 gap-9 text-center rounded-lg  my-8 w-full mx-auto   ">
        ...
        <div className="w-full lg:w-2/3 p-4  sticky top-10  ">
          <div className="w-full justify-around p-8 gap-9 text-center rounded-lg lg:-mt-32 ">
            <Outlet></Outlet>
          </div>
        </div>
      </div>
