...
const Header = () => {
  ...
  <li><NavLink to="/All-Contest" data-tooltip-id="my-tooltip" data-tooltip-content="Click Me to go All contest">All Contest</NavLink></li>
  
  {!user && <>
      <li><NavLink to="/login" data-tooltip-id="my-tooltip" data-tooltip-content="Click Me to go Login Page">Login</NavLink></li>
       <li><NavLink to="/signup" data-tooltip-id="my-tooltip" data-tooltip-content="Click Me to go to Register">Register</NavLink></li>
  </>}
  </>
     ...
     <div className="navbar">
                ...
                <div className="dropdown dropdown-end">
                    
                    {
                        ...
                        <li><a onClick={handleSignOut} className="btn btn-sm">Sign out</a></li>
                        </ul>
                        </>
                    }
                </div>
